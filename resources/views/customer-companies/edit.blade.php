...
<div class="py-12">
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-lg shadow border border-gray-200 p-6">
            ...
            <form action="{{ route('customers.companies.update', $customerCompany) }}" method="POST" class="space-y-4">
                @csrf
                @method('PUT')
                @if ($errors->any())
                ...
                <div class="flex gap-3 pt-2">
                    ...
                    <a href="{{ route('customers.companies.index') }}" class="px-4 py-2 border border-gray-300 rounded-md text-sm font-medium text-gray-700 hover:bg-gray-50">
                        Cancel
                    </a>
                </div>
            </form>
