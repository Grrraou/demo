        ...
        <div class="bg-white rounded-lg shadow border border-gray-200 p-6">
            <div class="flex justify-between items-start mb-6">
                ...
                <div class="flex items-center gap-2">
                    <a href="{{ route('sales.orders.pdf', $order) }}" target="_blank" class="px-3 py-1.5 text-sm font-medium text-gray-700 bg-gray-100 rounded-md hover:bg-gray-200">Download PDF</a>
